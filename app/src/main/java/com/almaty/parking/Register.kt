...
class Register : AppCompatActivity() {
    ...
    private lateinit var userCarNumber: TextInputEditText
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        userCarNumber = findViewById(R.id.regNumber)
        ...
        regBtn.setOnClickListener(View.OnClickListener {
            ...
            val addresses:String = userCarNumber.getText().toString()
            if (email.isEmpty() || name.isEmpty() || password.isEmpty() || password != password2 || addresses.isEmpty()) {
                showMessage("Please Verify all fields")
                regBtn.setVisibility(View.VISIBLE)
                loadingProgress.setVisibility(View.INVISIBLE)
            } else {
                CreateUserAccount(email, name, password, addresses)
            }
        })

    }

    private fun CreateUserAccount(email: String, name: String, password: String, address:String) {
